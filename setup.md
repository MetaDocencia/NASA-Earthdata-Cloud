...
2. Elige Anaconda Distribution (Distribution Installers). En la página de Anaconda vas a
ver dos opciones principales:
...
👉 Para este curso, si todavía no lo tienes instalado, lo más sencillo es que instales Anaconda Distribution.
